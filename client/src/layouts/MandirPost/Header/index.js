...
import ActiveMandirPosts from '../data/activeMandirPosts';
import InactiveMandirPosts from '../data/inactiveMandirPosts'
import DraftMandirPosts from '../data/draftMandirPosts'
