...
export default function CreateRewards({ createForm, setCreateForm, panditPrevDetail, info }) {
    ...
    async function onNext(e, formState) {
        ...
        const res = await fetch(`${apiUrl}pandit/additionalinfo/${panditPrevDetail?._id}`, {
            method: "PATCH",
            credentials: "include",
            headers: {
