...
import CreateGeography from './createGeography';

const Geography = ({ prevData }) => {
    const [data, setData] = useState(prevData);
    let columns = [
        { Header: "Delete", accessor: "delete", align: "center" },
        { Header: "Edit", accessor: "edit", align: "center" },
        { Header: "Geography", accessor: "geography", align: "center" },
    ];
    ...
    async function deletePurpose(elem){
        const res = await fetch(`${apiUrl}devta/deletegeography/${data?._id}`, {
            method: "DELETE",
            credentials: "include",
            headers: {
    ...
    return (
        ...
        <Card>
            ...
            {createForm && <>
                <CreateGeography createForm={createForm} setCreateForm={setCreateForm} prevData={prevData} prevInfo={id} setId={setId}  />
            </>
            }
            <MDBox mt={1}>
                <DataTable
