...
const About = () => {
    ...
    useEffect(()=>{
      axios.get(`${apiUrl}mandir/user/homedham?lat=${lat}&long=${long}&page=${page}&limit=${limit}`)
      .then((response)=>{
    ...
    const fetchData = async () => {
      ...
      if (check) {
        ...
        try {
          ...
          const response = await axios.get(`${apiUrl}mandir/user/homedham?lat=${lat}&long=${long}&page=${page}&limit=${limit}`);
          const newData = response?.data?.data;
