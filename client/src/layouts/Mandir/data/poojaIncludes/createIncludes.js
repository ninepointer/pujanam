...
export default function CreateIncludes({ setId, createForm, setCreateForm, prevData, prevInfo }) {
    ...
    async function onNext(e, formState) {
        ...
        const res = await fetch(`${apiUrl}pooja/include/${prevData?._id}`, {
            method: "PATCH",
            credentials: "include",
            headers: {
